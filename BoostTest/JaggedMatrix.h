...
public:
	...
	int GetSize() { return _size; }
	 ...
	 void AddDistribution(int r, int c, Distribution* distribution);
	 void AddDistribution(const TransitionInfo& info);

	 void AddDistribution(int r, int c, double meantime, double cov,
		 DistributionFactory::DistributionType failuretype=DistributionFactory::Weibull);


void AddDistribution(int r, int c, 
				   double meantime, double cov, 
...
JaggedMatrix(
	 ...
	 vector<double> Cellpdf(double t, int r, int c);
	 vector<double> CellReliability(double t, int r, int c);
	 double RowReliabilityProduct(double t, int r);

	 
	 double pdf(double t, int i, int j);		//cell of a matrix
	 matrix<double> pdf(double t);				//entire matrix
	 vector<double> pdf(double t, int r);		//row of a matrix

	 double Reliability(double t, int r, int c);
	 matrix<double> Reliability(double t);
	 vector<double> Reliability(double t, int r);

	 matrix<double> cdf(double t);
	 double cdf(double t, int r, int c);
